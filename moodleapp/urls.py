...
urlpatterns = [
    ...
    path('student/delete/<int:course_id>/', views.delete_course_from_student, name='deletecoursestudent'),
    ...
    path('teacher/delete/course/<int:course_id>/', views.delete_course, name='deletecourse'),
]
